  ...
  return (
    <div name='contact' className='w-full h-screen bg-white flex justify-center items-center p-4'>
      ...
      <div className='flex-col text-right'>
        ...
        <div className='border-2 border-black border-dashed rounded-full text-xl bg-[#91ff76] -mt-1 pr-8 py-2 cursor-pointer -mr-8 ml-8 hover:-mr-5 hover:ml-5 transition-all'>LinkedIn</div>
        ...
        <div className='border-2 border-black border-dashed rounded-full text-xl bg-[#f991f6] -mt-1 pl-4 pr-8 py-2 cursor-pointer -mr-8 ml-8 hover:-mr-5 hover:ml-5 transition-all'>Résumé</div>
      </div>
        <form 
