  ...
  return (
    <div name='contact' className='w-full h-screen bg-white flex justify-center items-center p-4'>
        <form method='POST' action="https://getform.io/f/4338ed21-dc0a-424f-a738-3a7e8cceb3be" className='flex flex-col max-w-[600px] w-full'>
            ...
            <input className='bg-[#fce7e7] p-2' type='text' placeholder='Name' name='name' />
            <input className='my-4 p-2 bg-[#fce7e7]' type='email' placeholder='Email' name='email' />
            <textarea className='bg-[#fce7e7] p-2' name='message' rows='10' placeholder='Message'></textarea>
